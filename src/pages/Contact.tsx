      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">rsirdc205@gmail.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63822.71470146717!2d29.188016097656252!3d-1.6677858999999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19dd00b6daed8ff9%3A0xdfff71944d7d15a5!2sGoma%2C%20Democratic%20Republic%20of%20the%20Congo!5e0!3m2!1sen!2sus!4v1694767661783!5m2!1sen!2sus" className="w-full h-64 rounded-lg border border-gray-200 dark:border-gray-700" title="Carte de Goma" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <Input id="name" type="text" placeholder="Votre nom" {...register("name")} className={errors.name ? "border-red-500" : ""} />
              ...
              <div>
                ...
                <Input id="email" type="email" placeholder="votre.email@exemple.com" {...register("email")} className={errors.email ? "border-red-500" : ""} />
              ...
              <div>
                ...
                <Input id="subject" type="text" placeholder="Sujet de votre message" {...register("subject")} className={errors.subject ? "border-red-500" : ""} />
              ...
              <div>
                ...
                <Textarea id="message" placeholder="Écrivez votre message ici..." rows={6} {...register("message")} className={errors.message ? "border-red-500" : ""} />
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Vous pouvez faire un don par virement bancaire sur notre compte FirstBANK DRC, SA: 00014280003010013790510. Pour plus d'informations, veuillez nous contacter directement.</p>
            </div>
